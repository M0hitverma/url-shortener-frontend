...
export const Footer = () => {
  return (
    <div className="px-6 pt-4 pb-10  bg-black flex flex-col gap-5 items-center justify-center ">
      ...
      <div>
        <Image src={linkIcon} alt="icon" height={60} width={60} />
      </div>
      <ul className="flex flex-1  flex-row gap-6 text-white text-md justify-center flex-wrap">
        <li className="flex flex-row gap-1 items-center cursor-pointer">
          ...
          <a
            href="https://api.whatsapp.com/send?phone=919541930799&text=Hi,%20Mohit"
            className=" hidden md:block"
            target="blank"
          >
            <span
              className=" border-b-[1px] border-black hover:border-green-300 
          "
            >
              Whatsapp
            </span>
        ...
        <li className="flex flex-row gap-1 items-center cursor-pointer ">
          ...
          <a
            href="https://www.linkedin.com/in/mohit-verma-231b66257/"
            target="blank"
            className="hidden md:block"
          >
        ...
        <li className="flex flex-row gap-1 items-center cursor-pointer">
          ...
          <a
            href="https://github.com/M0hitverma"
            target="blank"
            className="hidden md:block"
          >
        ...
        <li className="flex flex-row gap-1 items-center cursor-pointer">
          ...
          <a
            href="https://www.instagram.com/mr._mv_/"
            target="blank"
            className="hidden md:block"
          >
